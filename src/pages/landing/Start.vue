...
/** Hover para el nombre principal */
...
/** PNGs (si no están, no rompe, solo no se ven) */
...
<template>
      ...
      <div class="flex flex-1 overflow-hidden">
        ...
        <div class="flex-1 p-8 overflow-y-auto">
          <div class="rounded-md bg-[#242424] border border-white/10 p-6 relative">
            <button class="absolute right-3 top-3 text-white/50 hover:text-white/80" type="button">
              ✕
            </button>
            ...
            <p class="mt-2 text-sm text-blue-300 underline">ajustes preestablecidos de documentos</p>
          </div>
        ...
        <aside class="w-[380px] border-l border-white/10 p-6 bg-[#2d2d2d] flex flex-col">
          ...
          <!-- Nombre principal: SIN recuadro, solo línea + hover -->
          <div
            class="mt-3 pb-2 border-b border-white/15 cursor-default select-none"
          ...
          >
            ...
            <p class="mt-1 text-2xl font-semibold leading-none">
              {{ isNameHover ? "yonosoyessa.tiff" : "ESSA" }}
            </p>
          </div>

          <!-- EDAD (mismo tamaño que Valencia) + rol -->
          <div class="mt-4">
            <p class="text-xs text-white/60 mb-2">Edad</p>

            <div class="flex items-center gap-2">
              <!-- cajita peque (igual que ciudad) -->
              <div
          ...
          <!-- CIUDAD peque + ORIENTACIÓN con PNG (sin recuadro) -->
          <div class="mt-4">
  ...
  />
          ...
          <details class="mt-4">
            ...
            <div class="mt-3 rounded bg-[#1f1f1f] border border-white/10 p-3 space-y-2">
              <a class="block text-sm text-blue-300 hover:underline" :href="instagramUrl" target="_blank" rel="noreferrer">
                Instagram
              </a>
          ...
          <!-- BOTÓN CREAR (ancho completo) debajo de contacto -->
          <button
